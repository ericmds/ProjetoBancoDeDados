...
→ Empregado (_idEmpregado_, nome, CPF, tipoEmpregado, CREA, gerente, departamento)        | tentar ao máximo não deicar atributos NULL|
  ↳ tipo referencia Tipo                                                                  | sempre tentar deixar em uma tabela, para melhorar o processamento|
